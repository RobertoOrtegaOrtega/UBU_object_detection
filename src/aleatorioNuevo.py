...
def aleatorioNuevo(nombre):
    ...
    label1 = tkinter.Label(aleatorioNuevoGUI, text="¿Es la foto válida?", font=("Helvetica", 26),
    ...
    button = tkinter.Button(aleatorioNuevoGUI, text="SI",bg='white',font=("Helvetica", 16), relief="ridge", command=lambda: [aleatorioNuevoGUI.destroy(), finalizarMontaje(nombre,str(nombre[len(nombre)-1:])
                                                                                                                         ,1)])
    button.place(relx=0.33, rely=0.9,width=200, height=70, anchor="center")
    button1 = tkinter.Button(aleatorioNuevoGUI, text="NO",bg='white',font=("Helvetica", 16), relief="ridge", command=lambda: [aleatorioNuevoGUI.destroy(),aleatorioNuevo(nombre)])
